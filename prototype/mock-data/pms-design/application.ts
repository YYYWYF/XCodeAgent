...
export const WORKSPACE_ROOT = 'C:\\Users\\WX\\Documents\\ExampleWorkspace\\wh-branch-pms-design'

export const pmsDesignApplication: ApplicationConfig = {
  ...makeSchema(),
  id: 'app-pms-design',
  name: '武汉分行项目管理系统',
  ...
  schema: makeSchema(),
  planningConfirmedAt: Date.now() - 86400000,
  createdAt: Date.now() - 86400000 * 3
}

export const pmsDesignWorkspaceApplication = { application: makeSchema() }
