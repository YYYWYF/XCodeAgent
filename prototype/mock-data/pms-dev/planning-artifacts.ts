// 武汉分行项目管理系统 · 规划产物（驱动工作台大纲）。
// 开发镜像：my-projects 已设计（可预览），其余待设计。
...
export const PMS_PAGE_TREE = [
  {
    ...
    label: '项目管理',
    children: [
      { key: 'my-projects', type: 'page', label: '我的项目', path: '/my-projects', pageId: 'my-projects', designed: true, hasDetailPlan: true }
    ]
  },
  {
    key: 'rechecks',
...
export const PMS_API_CONTRACTS: DevelopmentPlanningApiContract[] = [
  {
    ...
    dataSourceIds: [],
    endpoints: [
      { id: 'ep-my-projects', method: 'GET', path: '/api/projects/my', summary: '我的项目分页查询（按状态/关键字筛选）', designed: true, hasDetailPlan: true },
