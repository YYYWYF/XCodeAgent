...
def create_test_generation_agent(
    ...
    *,
    ...
    system_prompt = (
        ...
        "use WebMvcTest only for changed route or validation contracts. If there is no suitable target, return a "
        "skipped JSON result. Do not run commands. Return one JSON object with status, "
