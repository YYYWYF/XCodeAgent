...
def create_test_generation_agent(
    ...
    *,
    ...
    system_prompt = (
        ...
        "already present in the project and JUnit 5/Mockito for every Java unit test, "
        ...
        "@WebMvcTest, @SpringBootTest, @MockBean, @Autowired or SpringExtension, and never add "
        "a dependency to make a generated test compile. Cover only the main path and one "
