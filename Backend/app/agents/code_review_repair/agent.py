...
def create_code_review_repair_agent(
    ...
    *,
    ...
    package_install_instruction = (
        ...
        "First apply the Skill remediation to package.json and then call the "
        "pnpm_install_frontend tool exactly once; that tool alone regenerates "
        "pnpm-lock.yaml. Calling pnpm_install_frontend is mandatory and is your "
        "responsibility — do not leave lockfile regeneration to the workflow. "
    ...
    system_prompt = (
        ...
        "or any other path. Never edit /frontend/pnpm-lock.yaml with file tools; when package "
        "installation is authorized, the lockfile is regenerated by the dedicated install tool, "
        "not by file edits. "
