...
def _data_source_generation_prompt(
    *,
    ...
    return (
        ...
        "source fields, scene entities, field mappings, and one-sentence business descriptions. Apply field mappings exactly "
        "and preserve one-sentence business descriptions in the service layer without inventing executable "
        "expressions. Source snapshots are confirmation-time non-sensitive facts. For external API "
