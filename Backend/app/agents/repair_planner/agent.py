...
def create_repair_planner_agent(
    ...
    *,
    ...
    base_system_prompt = (
        ...
        "or scheduler state. Treat contract_mismatch test failures as bounded "
        "data-source implementation repair work that must conform to the current "
        "confirmed contract. If a repair requires expanding change scope, changing "
