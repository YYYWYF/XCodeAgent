...
def _planning_prompt(
    ...
    return (
        ...
        "B. If a page belongs under that menu, emit the page path as its final full route, for example '/root/management/role' or '/root/management/resource'.\n"
        ...
        "If a menu unique_path is non-empty, every descendant page path must extend from that menu path. "
