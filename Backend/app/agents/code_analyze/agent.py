...
def create_code_analyze_agent(model, workspace_root: str | None = None):
    ...
    system_prompt = (
        ...
        "status, summary, loaded_skills, targets, issues, and truncated. Each issue must use a "
        "relative workspace path, side frontend/backend, optional rule_id, severity "
        "critical/high/medium/low, title, summary, and optional line. "
