...
def _classification_prompt(
    ...
    *,
    ...
    return (
        ...
        "Use out_of_scope for TechnicalPlan/API/request-response/database/data-source implementation "
        "requests (suggested_phase=planning), source-code/bug/refactor/dependency/command requests "
        "(suggested_phase=development), and test/run/verification requests (suggested_phase=test).\n"
