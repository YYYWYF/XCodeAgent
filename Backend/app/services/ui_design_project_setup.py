...
设计稿 .tsx 直接落到工作区 .devagentstudio/ui-design/pages/<PageKey>/index.tsx，
...
UI_DESIGN_RELATIVE_DIR = ".devagentstudio/ui-design"
...
def setup_ui_design_project(workspace: str | Path) -> dict[str, Any]:
    ...
    方案 B 下仅确保 .devagentstudio/ui-design 目录存在，供 persist_page_code
