...
major_version: 4
version: "4.24.16"
component_slug: "message"
component: "Message"
component_code_name: "message"
recommended_import: "import { message } from 'antd';"
subtitle_zh: "全局提示"
type_zh: "反馈"
demo_count: 8
---
...
- 组件名/导入对象：`message`
- 推荐导入：`import { message } from 'antd';`
- 组件分类：反馈
- 简述：全局展示操作反馈信息。
- 重要说明：message 是全局反馈 API，按小写对象使用，例如 message.success(...)。
