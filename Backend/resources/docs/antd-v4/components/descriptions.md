...
major_version: 4
version: "4.24.16"
component_slug: "descriptions"
component: "Descriptions"
component_code_name: "Descriptions"
recommended_import: "import { Descriptions } from 'antd';"
subtitle_zh: "描述列表"
type_zh: "数据展示"
demo_count: 6
---
...
- 组件名/导入对象：`Descriptions`
- 推荐导入：`import { Descriptions } from 'antd';`
- 组件分类：数据展示
- 简述：成组展示多个只读字段。
