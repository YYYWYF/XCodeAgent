...
component_slug: "grid"
component: "Grid"
component_code_name: "Row / Col"
recommended_import: "import { Row, Col } from 'antd';"
subtitle_zh: "栅格"
type_zh: "布局"
demo_count: 12
---
...
- 组件名/导入对象：`Row / Col`
- 推荐导入：`import { Row, Col } from 'antd';`
- 组件分类：布局
- 简述：24 栅格系统。
- 重要说明：Grid 文档主要对应 24 栅格系统，实际使用 Row 和 Col，响应式断点可用 Grid.useBreakpoint。
...
- 响应式布局（responsive）
- 其他属性的响应式（responsive-more）
- 栅格配置器（playground）
- useBreakpoint Hook（useBreakpoint）
